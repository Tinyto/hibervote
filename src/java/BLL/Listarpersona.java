    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         while(it.hasNext()){
             ...
             out.print("<h3>PERSONA "+p.getId()+"</h3>");
             out.print("<p>"+p.getNombre()+" "+p.getApellido()+"</p>");
             out.print("<p> Dirección: "+p.getDireccion().getCalle()+", Piso:"+p.getDireccion().getPiso()+",Portal:"+p.getDireccion().getPortal()+"</p>");
